...
class PropsColumnas
{
    ...
    public static function getBadge100()
    {
        return ["badge100" => true];
    }
    ...
    public static function getImg($width = 130, $titleIMG = "", $icon = "")
    {
        return ["img" => true, "width" => $width . "px", "titleIMG" => $titleIMG, "icon" => $icon,];
    }
