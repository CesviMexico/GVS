...
const HeaderComponent = () => {
    ...
    const swicthTipo = {
        "Login": () => { keycloak.login(process.env.REACT_APP_logoutOption) },
        "Salir": () => { keycloak.logout(process.env.REACT_APP_logoutOption) },
    }
    ...
    const PaletaColores = (props) => {
        ...
        return (
            <>
                <Typography variant="caption" display="block" gutterBottom >{texto}</Typography>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <MenuItem>
                    <ListItemIcon>
                        <Icon icon={reactIcon} style={{ fontSize: sizeIcon, color: backgroundColor }} />
                    </ListItemIcon>

                    <Typography variant="caption" display="block" gutterBottom >Menu 1</Typography>
                </MenuItem>
                <MenuItem>
                    <ListItemIcon>
                        <Icon icon={gamepadVariantOutline} style={{ fontSize: sizeIcon, color: backgroundColor }} />
                    </ListItemIcon>

                    <Typography variant="caption" display="block" gutterBottom >Menu 2</Typography>
                </MenuItem>

                {!keycloak.authenticated && (
                    <MenuItem onClick={(event) => handleSalir(event, 'Login')} >
                        <ListItemIcon>
                            <Icon icon={exitRun} style={{ fontSize: sizeIcon, color: backgroundColor }} />
                        </ListItemIcon>
                        <Typography variant="caption" display="block" gutterBottom > Login  {keycloak.authenticated}</Typography>
                    </MenuItem>
                )}
                ...
                {!!keycloak.authenticated && (
                    <MenuItem onClick={(event) => handleSalir(event, 'Salir')} >
                        ...
                        <Typography variant="caption" display="block" gutterBottom > Salir  {keycloak.tokenParsed.preferred_username}</Typography>
                    </MenuItem>
                )}
                <Divider />
