...
export const DeleteElement = async (setloading, msErrorApi, keycloak, logoutOptions, data_id) => {
    const response = await getAxiosLumen({
        uri: `/user/${data_id}`,
        setloading: setloading,
        msErrorApi: msErrorApi,
...
export const MenuPermissions = async (setloading, msErrorApi, keycloak, logoutOptions, data_id) => {
    const response = await getAxiosLumen({
        uri: `/menu/${data_id}/permisos`,
        setloading: setloading,
        msErrorApi: msErrorApi,
        keycloak: keycloak,
        notification: false,
